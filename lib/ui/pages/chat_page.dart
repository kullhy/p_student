...
import 'package:p_student/ui/pages/chat_widget.dart';
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (conntext, index) {
                      return InkWell(
                        onTap: () {
                          _viewModel
                              .setChatUID(viewModel.students[index].uid ?? "");
                        },
                        child: Container(
                      ...
                      _viewModel.uid!=""? Expanded(child: ChatWidget(viewModel: _viewModel)):Container(),
